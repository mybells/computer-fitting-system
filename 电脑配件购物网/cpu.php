...
<dl class="screening">
    <dt>厂商</dt>
    <dd class="limit"><a href="cpu.php?biaoqian=cpu" class="active">不限</a></dd>
    <dd class="screening_list">
    <ul>
    <li><a href="cpu.php?biaoqian=Intel/英特尔">Intel/英特尔</a></li>
    <li><a href="cpu.php?biaoqian=AMD">外星人</a></li>
    <li><a href="cpu.php?biaoqian=酷睿">酷睿</a></li>
    </ul>
    </dd>
</dl>
<dl class="screening">
    ...
    <dd class="screening_list">
    <ul>
 <li><a href="cpu.php?biaoqian=cpu&biaoqian1=order by jiage DESC">从高到低</a></li>
        <li><a href="cpu.php?biaoqian=cpu&biaoqian1=order by jiage ASC">从低到高</a></li>
    </dd>
</dl>
</div>
