...
<dl class="screening">
    <dt>厂商</dt>
    <dd class="limit"><a href="diannao.php?biaoqian=电脑" class="active">不限</a></dd>
    <dd class="screening_list">
    <ul>
    <li><a href="diannao.php?biaoqian=联想">联想</a></li>
    <li><a href="diannao.php?biaoqian=外星人">外星人</a></li>
    <li><a href="diannao.php?biaoqian=htc">htc</a></li>
    </ul>
    </dd>
</dl>
<dl class="screening">
    ...
    <dd class="screening_list">
    <ul>
        <li><a href="diannao.php?biaoqian=电脑&biaoqian1=order by jiage DESC">从高到低</a></li>
        <li><a href="diannao.php?biaoqian=电脑&biaoqian1=order by jiage ASC">从低到高</a></li>
    </dd>
</dl>
</div>
	<?php 
