<?php
	...
	$biaoqian=$_GET['biaoqian'];
	@$biaoqian1=$_GET['biaoqian1'];
	$query = mysql_query("select * from search where shangping like '%$biaoqian%'".$biaoqian1);
//	$qq=array();
	?>
<html>
<head>
...
<style>
	...
	.screening_list li{float: left;border: 1px solid #fff;list-style: none;}
    .zhuye{
	float: left;
	font-weight: bold;
          }	
          .screening_list ul{margin-top: 15px;}
      </style>
</head>
<body>
...
<dl class="screening">
    <dt>厂商</dt>
    <dd class="limit"><a href="xianshiqi.php?biaoqian=显示器" class="active">不限</a></dd>
    <dd class="screening_list">
    <ul>
    <li><a href="xianshiqi.php?biaoqian=索尼">Sony/索尼</a></li>
    <li><a href="xianshiqi.php?biaoqian=苹果">Apple/苹果</a></li>
    <li><a href="xianshiqi.php?biaoqian=三星">Samsung/三星</a></li>
    </ul>
    </dd>
</dl>
<dl class="screening">
    ...
    <dd class="screening_list">
    <ul>
        <li><a href="xianshiqi.php?biaoqian=显示器&biaoqian1=order by jiage DESC">从高到低</a></li>
        <li><a href="xianshiqi.php?biaoqian=显示器&biaoqian1=order by jiage ASC">从低到高</a></li>
    </dd>
</dl>
</div>
...
<a href="goumai.php?danjia=<?php echo $w ?>&spname=<?php echo $q ?>">立即购买</a>
 <a href="joingouwu.php?danjia=<?php echo $w ?>&spname=<?php echo $q ?>">加入购物车</a>
 </div>
 </div>
</div><?php } ?>
</body>
