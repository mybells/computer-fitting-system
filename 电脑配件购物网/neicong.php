...
<dl class="screening">
    <dt>厂商</dt>
    <dd class="limit"><a href="neicong.php?biaoqian=内存" class="active">不限</a></dd>
    <dd class="screening_list">
    <ul>
    <li><a href="neicong.php?biaoqian=HP">HP</a></li>
    <li><a href="neicong.php?biaoqian=金士顿">金士顿</a></li>
    <li><a href="neicong.php?biaoqian=AData/威刚">AData/威刚</a></li>
    </ul>
    </dd>
</dl>
<dl class="screening">
    ...
    <dd class="screening_list">
    <ul>
        <li><a href="neicong.php?biaoqian=内存&biaoqian1=order by jiage DESC">从高到低</a></li>
        <li><a href="neicong.php?biaoqian=内存&biaoqian1=order by jiage ASC">从低到高</a></li>
    </dd>
</dl>
</div>
